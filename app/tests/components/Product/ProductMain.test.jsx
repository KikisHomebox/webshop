...
jest.mock('../../../components/Product/ProductForm', () => () => {
...
describe('Singe Product Main component', () => {
  it('renders Singe Product Main with all components', () => {
    render(<ProductMain product={MOCK_PRODUCT} variants={MOCK_VARIANTS} />);
